...
export const API_ENDPOINTS = {
  ...
  bookings: {
    ...
    review: (id) => `${API_BASE_URL}/api/bookings/${id}/review`,
  ...
  payments: {
    ...
    dashboardStats: `${API_BASE_URL}/api/payments/dashboard-stats`,
    managerEarnings: `${API_BASE_URL}/api/payments/manager-earnings`,
  ...
  admin: {
    ...
    approveUser: (id) => `${API_BASE_URL}/api/admin/users/${id}/approve`,
    rejectUser: (id) => `${API_BASE_URL}/api/admin/users/${id}/reject`,
